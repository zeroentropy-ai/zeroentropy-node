...
export class APIPromise<T> extends Promise<T> {
   ...
   * or add one of these imports before your first `import … from 'zeroentropy'`:
   * - `import 'zeroentropy/shims/node'` (if you're running on Node)
   * - `import 'zeroentropy/shims/web'` (otherwise)
   */
